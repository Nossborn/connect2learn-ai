...
// primitive blocks:
    ...
    */
    ...
    // control:
    'Find %s using %bimatch with normalized %bool , %numres of results and bigrams %bool':
        'Hitta %s med %bimatch och normaliserad %bool , %numres resultat och anv\u00E4nd bigram %bool',
    'Answer %s':
        'Svara på %s',
    'Find %s':
        'Hitta %s',
    ...
    'Find %s using %match':
        'Hitta %s med %match',
    'Find %s using %bimatch with bigrams':
        'Hitta %s med %bimatch och bigram',
    ...
    'delete %ida of %l':
        'radera %ida fr\u00E5n %l',
    'move %idm of %l to %idm':
        'flytta %idm i %l till %idm',
