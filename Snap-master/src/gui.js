...
//Declare Global ERICSSON Color variables
var eriCol18, eriCol24, eriCol36, eriCol118, eriCol160, eriCol224, eriCol242, eriCol255;
var eriColBlue, eriColRed, eriColOrange, eriColYellow, eriColGreen, eriColPurple;

IDE_Morph.prototype.setCTLDesign = function() {
    eriCol18 = new Color(18, 18, 18);
    eriCol24 = new Color(24, 24, 24);
    eriCol36 = new Color(36, 36, 36);
    eriCol118 = new Color(118, 118, 118);
    eriCol160 = new Color(160, 160, 160);
    eriCol224 = new Color(224, 224, 224);
    eriCol242 = new Color(242, 242, 242);
    eriCol255 = new Color(255, 255, 255);

    eriColBlue = new Color(0, 130, 240);
    eriColRed = new Color(255, 50, 50);
    eriColOrange = new Color(255, 140, 10);
    eriColYellow = new Color(250, 210, 45);
    eriColGreen = new Color(15, 195, 115);
    eriColPurple = new Color(175, 120, 210);

    SpriteMorph.prototype.blockColor = {
    motion : eriColBlue,
    looks : eriColPurple,
    sound : eriColRed,
    pen : new Color(112, 219, 170),         //Variation of eriColGreen
    control : eriColOrange,
    sensing : new Color(66, 181, 244),      //Variation of eriColBlue
    operators : eriColGreen,
    variables : new Color(255,132,132),      //Variation of eriColRed
    lists : new Color(217, 77, 17),
    other: new Color(150, 150, 150)
};

    DialogBoxMorph.prototype.titleBarColor = eriCol18;
    DialogBoxMorph.prototype.titleTextColor = eriCol255;
    PushButtonMorph.prototype.dialogButtonLabelColor = eriCol18;

    PushButtonMorph.prototype.labelColor = eriCol18;
    PushButtonMorph.prototype.color = eriCol224;
    PushButtonMorph.prototype.pressColor = PushButtonMorph.prototype.color.darker(30);
    PushButtonMorph.prototype.highlightColor = PushButtonMorph.prototype.color.darker(15);

    IDE_Morph.prototype.barColor = eriCol18;
    var barButtonColor = this.barColor;
    IDE_Morph.prototype.barButtonColors = [
        barButtonColor.lighter(30),   //Press
        barButtonColor.lighter(15),   //Hover
        barButtonColor                //Normal
    ];
    IDE_Morph.prototype.barButtonLabelColor = eriCol255;

    IDE_Morph.prototype.categoryListBackgroundColor = PushButtonMorph.prototype.color;
    IDE_Morph.prototype.categoryListColor = this.categoryListBackgroundColor;
    IDE_Morph.prototype.categoryListHoverColor = this.categoryListColor.darker(15);
    IDE_Morph.prototype.categoryButtonLabelColor = eriCol18;

    SpriteMorph.prototype.blockListBackgroundColor = eriCol242;

    IDE_Morph.prototype.scriptAreaColor = eriCol224; //Also used for costume and sound tabs

    var tabColor = this.scriptAreaColor;
    IDE_Morph.prototype.tabColors = [
        tabColor.darker(15),    //Unselected
        tabColor.darker(30),   //Hover
        tabColor                //Selected
    ];
    IDE_Morph.prototype.tabLabelColor = eriCol18;
    IDE_Morph.prototype.spriteBarColor = SpriteMorph.prototype.blockListBackgroundColor;
    var spriteBarRotationStyleColor = this.spriteBarColor.darker(15);
    IDE_Morph.prototype.spriteBarRotationStyleColors = [
        spriteBarRotationStyleColor.lighter(30),   //Selected
        spriteBarRotationStyleColor.lighter(15),   //Hover
        spriteBarRotationStyleColor                //Unselected
    ];
    IDE_Morph.prototype.rotationButtonLabelColor = eriCol18;
    IDE_Morph.prototype.spriteInputNameFieldContrast = 255;
    IDE_Morph.prototype.checkboxTextColor = eriCol18;
    var checkboxColor = eriColBlue.lighter(30);
    IDE_Morph.prototype.checkboxColors = [
        checkboxColor.lighter(30), //Press
        checkboxColor.lighter(15), //Hover
        checkboxColor              //Normal
    ];
    IDE_Morph.prototype.checkboxTickColor = eriCol255;

    IDE_Morph.prototype.corralBarColor = this.categoryListBackgroundColor;
    IDE_Morph.prototype.corralAreaColor = SpriteMorph.prototype.blockListBackgroundColor;
    var corralAreaSpriteColor = this.corralAreaColor;
    IDE_Morph.prototype.corralAreaSpriteColors = [
        corralAreaSpriteColor.darker(30),   //Selected
        corralAreaSpriteColor.darker(15),   //Hover
        corralAreaSpriteColor                //Unselected
    ];

    IDE_Morph.prototype.corralBarButtonLabelColor = eriCol18;
    IDE_Morph.prototype.corralBarButtonContrast = 0;
    var corralBarButtonColor = this.corralBarColor;
    IDE_Morph.prototype.corralBarButtonColors = [
        corralBarButtonColor.darker(30), //Press
        corralBarButtonColor.darker(15), //Hover
        corralBarButtonColor              //Normally
    ];

    var costumeButtonColor = this.scriptAreaColor;
    IDE_Morph.prototype.costumeButtonColors = [
        costumeButtonColor.darker(30), //Press
        costumeButtonColor.darker(15), //Hover
        costumeButtonColor              //Normal
    ];
    IDE_Morph.prototype.costumeButtonLabelColor = eriCol18;
    IDE_Morph.prototype.costumeHelpTextColor = eriCol18;
    IDE_Morph.prototype.costumeTextColor = this.costumeHelpTextColor;
    IDE_Morph.prototype.CostumeTurtleBackgroundColor = this.scriptAreaColor;
    IDE_Morph.prototype.turtleIconColor = eriColBlue;

    IDE_Morph.prototype.soundHelpTextColor = this.costumeHelpTextColor;
    
    var soundsRecordButtonColor = this.scriptAreaColor;
    IDE_Morph.prototype.soundsRecordButtonColors = [
        soundsRecordButtonColor.darker(30), //Press
        soundsRecordButtonColor.darker(15), //Hover
        soundsRecordButtonColor              //Normal        
    ];
    IDE_Morph.prototype.soundsRecordIconColor = eriColRed;
    IDE_Morph.prototype.soundsPlayIconColor = eriColGreen;
    ToggleButtonMorph.prototype.paintIconsColor = eriCol18;
}
...
IDE_Morph.prototype.setFlatDesign = function () {
    ...
    SpriteMorph.prototype.paletteColor = eriCol36;
    SpriteMorph.prototype.paletteTextColor = eriCol36;
    ...
    IDE_Morph.prototype.backgroundColor = eriCol242; //Controls borders around different areas
    IDE_Morph.prototype.frameColor = eriCol24;

    IDE_Morph.prototype.groupColor = eriCol36;
    IDE_Morph.prototype.sliderColor = SpriteMorph.prototype.sliderColor;
    IDE_Morph.prototype.buttonLabelColor = eriCol255;
...
IDE_Morph.prototype.init = function (isAutoFill) {
    // global font setting
    MorphicPreferences.globalFontFamily = 'EricssonHilda-regular';
...
//    this.logoURL = this.resourceURL('src', 'snap_logo_sm.png');
    this.logoURL = this.resourceURL('src', 'ERI.png');
    this.logo = null;
...
IDE_Morph.prototype.createLogo = function () {
    ...
    this.logo.drawNew = function () {
        ...
        gradient.addColorStop(0.5, myself.barColor.toString());
        context.fillStyle = MorphicPreferences.isFlat ?
                myself.barColor.toString() : gradient;
    ...
    this.logo.drawCachedTexture = function () {
        //Edited here, added padding calulated from top
        //Rescaled image
        var context = this.image.getContext('2d');
        var padding = 3;
        var realImgHeight = this.height() - 2 * padding;
        var realImgWidth = realImgHeight * (this.cachedTexture.width / this.cachedTexture.height);
    ...
    this.logo.setExtent(new Point(225, 28)); // dimensions are fixed
    //this.logo.setExtent(new Point(42, 28)); // dimensions are fixed
    this.add(this.logo);
};
...
IDE_Morph.prototype.createControlBar = function () {
    ...
    var padding = 5,
        ...
        colors = [
            this.barColor,
            this.barButtonColors[2],
            this.barButtonColors[0],
            this.barButtonColors[1]
        ],
        myself = this;
    ...
    button.highlightColor = colors[3];
    button.pressColor = colors[2];
    button.labelMinExtent = new Point(36, 24);
    button.padding = 0;
    button.labelShadowOffset = new Point(-1, -1);
    button.labelShadowColor = colors[1];
    button.labelColor = this.barButtonLabelColor;
    ...
    button.labelShadowOffset = new Point(-1, -1);
    button.labelShadowColor = colors[1];
    button.labelColor = eriColYellow;
    button.contrast = this.buttonContrast;
    button.drawNew();
    ...
    this.controlBar.updateLabel = function () {
        ...
        this.label = new StringMorph(
            ...
            14,
            'EricssonHilda-regular',
            true,
            false,
            false,
            MorphicPreferences.isFlat ? null : new Point(2, 1),
            myself.barColor.darker(myself.buttonContrast)
        );
        this.label.color = myself.barButtonLabelColor;
        this.label.drawNew();
        this.add(this.label);
...
IDE_Morph.prototype.createCategories = function () {
    ...
    this.categories.color = this.categoryListBackgroundColor;
    this.categories.silentSetWidth(this.paletteWidth);

    function addCategoryButton(category) {
        var labelWidth = 75,
            colors = [
                myself.categoryListColor,
                myself.categoryListHoverColor,
                SpriteMorph.prototype.blockColor[category] //Color when selected
            ],
            button;
        ...
        button.labelShadowOffset = new Point(-1, -1);
        button.labelShadowColor = colors[1];
        button.labelColor = myself.categoryButtonLabelColor;
        button.fixLayout();
        button.refresh();
...
IDE_Morph.prototype.createSpriteBar = function () {
    ...
    function addRotationStyleButton(rotationStyle) {
        var colors = myself.spriteBarRotationStyleColors,
            button;
        ...
        button.padding = 0;
        button.labelShadowOffset = new Point(-1, -1);
        button.labelShadowColor = myself.rotationStyleButtonsColor;
        button.labelColor = myself.rotationButtonLabelColor;
        button.fixLayout();
        button.refresh();
    ...
    nameField.contrast = this.spriteInputNameFieldContrast;
    ...
    padlock.label.setColor(this.checkboxTextColor);
    padlock.color = this.checkboxColors[2];
    padlock.highlightColor = this.checkboxColors[1];
    padlock.pressColor = this.checkboxColors[0];

    padlock.tick.shadowOffset = MorphicPreferences.isFlat ?
            new Point() : new Point(-1, -1);
    padlock.tick.shadowColor = this.checkboxTickColor;
    padlock.tick.color = this.checkboxTickColor;
    ...
    tab.labelColor = this.tabLabelColor;
    tab.drawNew();
    tab.fixLayout();
    tabBar.add(tab);
...
IDE_Morph.prototype.createSpriteEditor = function () {
    ...
    if (this.currentTab === 'scripts') {
        ...
        scripts.color = this.scriptAreaColor;
        ...
        this.spriteEditor.color = this.scriptAreaColor;
        this.add(this.spriteEditor);
...
IDE_Morph.prototype.createCorralBar = function () {
    ...
    var padding = 5,
        ...
        cambutton,
        colors = [
            this.corralBarButtonColors[2],
            this.corralBarButtonColors[1],
            this.corralBarButtonColors[0]
        ];
    ...
    newbutton.labelColor = this.corralBarButtonLabelColor;
    newbutton.contrast = this.corralBarButtonContrast;
    newbutton.drawNew();
    ...
    paintbutton.labelColor = this.corralBarButtonLabelColor;
    paintbutton.contrast = this.corralBarButtonContrast;
    paintbutton.drawNew();
    ...
    if (CamSnapshotDialogMorph.prototype.enableCamera) {
        ...
        cambutton.labelColor = this.corralBarButtonLabelColor;
        cambutton.contrast = this.corralBarButtonContrast;
        cambutton.drawNew();
...
IDE_Morph.prototype.createCorral = function () {
    ...
    this.corral.color = this.corralAreaColor;
...
IDE_Morph.prototype.toggleRetina = function () {
    ...
    this.world().fillPage();
    IDE_Morph.prototype.scriptsPaneTexture = null; //this.scriptsTexture();
...
IDE_Morph.prototype.toggleAppMode = function (appMode) {
    ...
    if (this.isAppMode) {
        ...
        this.controlBar.setColor(this.barColor);
        elements.forEach(function (e) {
            e.show();
        });
...
SpriteIconMorph.prototype.labelColor = IDE_Morph.prototype.costumeHelpTextColor;
...
SpriteIconMorph.prototype.init = function (aSprite, aTemplate) {
    ...
    if (!aTemplate) {
        colors = [
            IDE_Morph.prototype.corralAreaSpriteColors[2],
            IDE_Morph.prototype.corralAreaSpriteColors[1],
            IDE_Morph.prototype.corralAreaSpriteColors[0]
        ];
...
CostumeIconMorph.prototype.labelColor = IDE_Morph.prototype.costumeHelpTextColor;
...
CostumeIconMorph.prototype.init = function (aCostume, aTemplate) {
    ...
    if (!aTemplate) {
        colors = [
            IDE_Morph.prototype.CostumeTurtleBackgroundColor,
            IDE_Morph.prototype.CostumeTurtleBackgroundColor.darker(15),
            IDE_Morph.prototype.CostumeTurtleBackgroundColor.darker(30)
        ];
...
TurtleIconMorph.prototype.labelColor = IDE_Morph.prototype.turtleIconColor;
...
TurtleIconMorph.prototype.createLabel = function () {
    ...
    txt = new StringMorph(
        ...
        this.labelShadowOffset,
        this.labelShadowColor,
        IDE_Morph.prototype.costumeTextColor
    );
...
WardrobeMorph.prototype.updateList = function () {
    ...
    paintbutton.padding = 0;
    paintbutton.corner = 12;
    paintbutton.color = IDE_Morph.prototype.costumeButtonColors[2];
    paintbutton.highlightColor = IDE_Morph.prototype.costumeButtonColors[1];
    paintbutton.pressColor = IDE_Morph.prototype.costumeButtonColors[0];
    paintbutton.labelMinExtent = new Point(36, 18);
    paintbutton.labelShadowOffset = new Point(-1, -1);
    paintbutton.labelShadowColor = paintbutton.highlightColor;
    paintbutton.labelColor = IDE_Morph.prototype.costumeButtonLabelColor;
    ...
    if (CamSnapshotDialogMorph.prototype.enableCamera) {
        ...
        cambutton.padding = 0;
        cambutton.corner = 12;
        cambutton.color = IDE_Morph.prototype.costumeButtonColors[2];
        cambutton.highlightColor = IDE_Morph.prototype.costumeButtonColors[1];
        cambutton.pressColor = IDE_Morph.prototype.costumeButtonColors[0];
        cambutton.labelMinExtent = new Point(36, 18);
        cambutton.labelShadowOffset = new Point(-1, -1);
        cambutton.labelShadowColor = cambutton.highlightColor;
        cambutton.labelColor = IDE_Morph.prototype.costumeButtonLabelColor;
    ...
    txt.fontSize = 9;
    txt.setColor(IDE_Morph.prototype.costumeHelpTextColor);
...
SoundIconMorph.prototype.labelColor = IDE_Morph.prototype.soundHelpTextColor;
...
JukeboxMorph.prototype.updateList = function () {
    ...
    txt.fontSize = 9;
    txt.setColor(IDE_Morph.prototype.soundHelpTextColor);
    txt.setPosition(new Point(x, y));
    this.addContents(txt);
    ...
    recordButton.color = IDE_Morph.prototype.soundsRecordButtonColors[2];
    recordButton.highlightColor = IDE_Morph.prototype.soundsRecordButtonColors[1];
    recordButton.pressColor = IDE_Morph.prototype.soundsRecordButtonColors[0];
    ...
    recordButton.labelColor = IDE_Morph.prototype.costumeTextColor;
    recordButton.contrast = this.buttonContrast;
    recordButton.drawNew();
    recordButton.hint = 'Record a new sound';
    recordButton.fixLayout();
    recordButton.label.setColor(IDE_Morph.prototype.soundsRecordIconColor);
...
SoundRecorderDialogMorph.prototype.record = function () {
    ...
    this.recordButton.label.setColor(IDE_Morph.prototype.soundsRecordIconColor);
...
SoundRecorderDialogMorph.prototype.play = function () {
    ...
    this.playButton.label.setColor(IDE_Morph.prototype.soundsPlayIconColor);
};
