...
*/
    ...
    motion : new Color(0, 130, 240),        //eriColBlue
    looks : new Color(175, 120, 210),       //eriColPurple
    sound : new Color(255, 50, 50),         //eriColRed
    pen : new Color(112, 219, 170),         //Variation of eriColGreen
    control : new Color(255, 140, 10),      //eriColOrange
    sensing : new Color(66, 181, 244),      //Variation of eriColBlue
    operators : new Color(15, 195, 115),    //eriColGreen
    variables : new Color(198, 168, 35),    //Variation of eriColYellow
    lists : new Color(217, 77, 17),         //Unchanged
    other: new Color(150, 150, 150)         //Unchanged
};
...
SpriteMorph.prototype.initBlocks = function () {
    SpriteMorph.prototype.blocks = {
        ...
        CTLfindComplete: {
            ...
            type: 'reporter',
            category: 'control',
            spec: 'Find %s using %bimatch with normalized %bool , %numres results and bigrams %bool'
        },
        CTLanswerQ: {
        	dev: true,
            only: SpriteMorph,
        ...
        CTLfind: {
            ...
            type: 'reporter',
            category: 'control',
            spec: 'Find %s using %match'
        },
        CTLfindBigram: {
            only: SpriteMorph,
            type: 'reporter',
            category: 'control',
            spec: 'Find %s using %bimatch with bigrams'
        },
        receiveGo: {
            type: 'hat',
            category: 'control',
        ...
        reportListContainsItem: {
            ...
            category: 'lists',
            spec: '%l contains %s',
            defaults: [null, localize('touching')]
        },
        doAddToList: {
            type: 'command',
            category: 'lists',
        ...
        CTLmove: {
            type: 'command',
            category: 'lists',
            spec: 'move word %idm of %l to %idm',
            defaults: [1]
        },
        CTLdelete: {
            type: 'command',
            category: 'lists',
            spec: 'delete word %idm of %l',
            defaults: [1]
        },
        doInsertInList: {
            type: 'command',
...
SpriteMorph.prototype.blockTemplates = function (category) {
    ...
    /////////////////////////////////
        ...
        blocks.push('-');
        blocks.push(block('CTLsearchFor'));
        blocks.push(block('CTLfind'));
        blocks.push(block('CTLfindBigram'));
        blocks.push(block('CTLfindComplete'));
        blocks.push('-');
    ...
    ///////////////////////////////
        ...
        blocks.push('-');
        blocks.push(block('CTLmove'));
        blocks.push(block('CTLdelete'));
        blocks.push('-');
...
SpriteMorph.prototype.freshPalette = function (category) {
    ...
    palette.color = SpriteMorph.prototype.blockListBackgroundColor;
...
StageMorph.prototype.init = function (globals) {
    ...
    this.setColor(IDE_Morph.prototype.stageColor);
