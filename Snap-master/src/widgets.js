...
PushButtonMorph.prototype.fontStyle = 'EricssonHilda-regular';
...
PushButtonMorph.prototype.titleBarColor = new Color(255,255,255);

PushButtonMorph.prototype.color = new Color(0, 0, 0);
PushButtonMorph.prototype.pressColor = new Color(0, 0, 0);
PushButtonMorph.prototype.highlightColor = new Color(0, 0, 0);
        ...
        if (this.labelString instanceof SymbolMorph) {
            ...
            if (!this.isPicture) {
                this.label.shadowOffset = shading ?
                        this.labelShadowOffset : none;
                this.label.shadowColor = this.labelShadowColor;
                this.label.color = this.paintIconsColor;
                this.label.drawNew();
            }
...
DialogBoxMorph.prototype.fontStyle = 'EricssonHilda-regular';
...
DialogBoxMorph.prototype.titleBarColor = PushButtonMorph.prototype.titleBarColor;
